    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(help_text='Please Select Address to Send Order There', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='customer.address', verbose_name='Address')),
                ...
                ('discount', models.ForeignKey(blank=True, default=None, help_text='Please Select Discount from Discount Codes to Apply on Price', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='order.discountcode', verbose_name='Discount Value')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modify_timestamp', models.DateTimeField(auto_now=True, verbose_name='Modify TimeStamp')),
                ('delete_timestamp', models.DateTimeField(blank=True, default=None, null=True)),
                ('count', models.PositiveIntegerField(default=1, help_text='Please Selcet the Count of this Order Item(Minimum Value is 1).', validators=[django.core.validators.MinValueValidator(1)], verbose_name='Count of Order Item')),
