    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_code', models.BooleanField(db_index=True, default=False, help_text='Please Select Check Box if is the Discount Code else Do Nothing.', verbose_name='Has Code')),
            ],
            options={
